...
<html>
  ...
  <div id="nr1">
	...
	<input type="text" id="fst_nm" name="fst_nm" class="box"/>
	</div>
    <div id="lastname" >LastName:
	<input type="text" id="lst_nm" name="lst_nm" class="box"/>
	</div>
 </div>
 <div id="nr2">
	...
	<input type="password" id="pass" name="passwd" class="box"/>
	</div>
	<div id="password" >Retype Password:
	<input type="password" id="ret_pass" name="passwd" class="box2"/>
	</div>
 </div>
  <div id="nr3">
    <div id="mobile">Mobile_number:
	<input type="text" id="mobile" name="mbb" placeholder="optional..." class="box"/>
	</div>
  </div>
    <div id="nr4">
    <div id="birthday">Birthday:
	<select name='mm' id='month' data='birthday-drop-down' >
    <option value=''>Month</option><option title=January value='1'>January</option><option title=February value='2'>February</option><option title=March value='3'>March</option><option title=April value='4'>April</option><option title=May value='5'>May</option><option title=June value='6'>June</option><option title=July value='7'>July</option><option title=August value='8'>August</option><option title=September value='9'>September</option><option title=October value='10'>October</option><option title=November value='11'>November</option><option title=December value='12'>December</option>	                  
	</select>
	
	
    <select name='dd' id='day' data='birthday-drop-down'>
    ...
    <option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option><option value='6'>6</option><option value='7'>7</option><option value='8'>8</option><option value='9'>9</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option><option value='31'>31</option>	                  
     ...
     <select name='yyyy' id='year' data='birthday-drop-down'>
   ...
   <div id="nr5">
	 <div class='column' role="radiogroup" >Gender:
   ...
   <p name="cap">Enter Code:
	...
	<footer>
		   <p name="ftt"> SNAPCHAT</p>
		   <p name="ftt2">&copy 2014---SNEP_PETRU_ADRIAN---All rights reserved </p>
		 </footer>
